...
<head>
    ...
    <link rel="stylesheet" href="http://ustsimbahayanportal.com/Simbahayan/simbahayan-ui/css/pdf_page.css" />
    <link rel="stylesheet" href="http://ustsimbahayanportal.com/Simbahayan/simbahayan-ui/css/print.css" />
...
function get_kra3datafromuserid(){
    ...
    $.ajax({
        ...
        complete: function (response) {
            ...
            var final_kra310t=parseInt(pot_arr[0]) + parseInt(gat_arr[0]) + parseInt(ngot_arr[0]) + parseInt(beit_arr[0]) + parseInt(iheit_arr[0]) + parseInt(iheit_arr[0]) + parseInt(cbot_arr[0]) + parseInt(pbot_arr[0]);

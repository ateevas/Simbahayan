                    ...
                    <div class="card card-registration my-4">
                        <div class="row g-0">
                            <div class="col-xl-6 d-none d-xl-block">
                                <img src="http://localhost/Simbahayan/login-page/register/pictures/1024px-UST_colors.svg.png"
                                    alt="Sample photo" class="img-fluid"
                                    style="border-top-left-radius: 0.25rem; border-bottom-left-radius: 0.25rem" />
                            </div>
                            <div class="col-xl-6">
                                <div class="card-body p-md-5 text-black">
                                    <h2 style="color:black">Community Development Coordinator</h2>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <select id="col_selection" class="form-control">
                                            ...
                                            <option value="6">Faculty of Fine Arts and Design</option>
                                            ...
                                            <option value="22">University-Wide Student Organization</option>
                                    ...
                                    <div class="d-flex justify-content-end pt-3">
                                        <button type="button" class="btn btn-light btn-lg" onclick="inputReset()">Reset
                                            all</button>
                                        <button type="button" class="btn btn-warning btn-lg ms-2"
                                            onclick="inputSubmit()">Submit form</button>
                                    </div>
                                </div>
                            </div>
                        </div>

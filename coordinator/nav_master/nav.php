            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item ">
                    <a class=" nav-link active" aria-current="page"
                        href="http://localhost/Simbahayan/coordinator/php/profile.php">Profile</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost/Simbahayan/coordinator/php/pending.php">
                ...
                <li class="nav-item dropstart">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li><a class="dropdown-item" href="http://localhost/Simbahayan/coordinator/php/manage.php">
                                Manage Students</a>
                        </li>
                        <li><a class="dropdown-item" href="http://localhost/Simbahayan/coordinator/php/dashboard.php">
                                Dashboard</a>
                        </li>
                        <li><a class="dropdown-item"
                                href="http://localhost/Simbahayan/coordinator/php/changepass.php">Change
                                Password</a>
                        </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost/Simbahayan/coordinator/php/contact.php">
                        Contact
                    </a>
                </li>
                <li class="nav-item">

					...
					<div class="card mb-4 mb-xl-0">
						...
						<div class="card-body text-center">
							...
							<div id="display-image">
								<img src="https://cdn-icons-png.flaticon.com/512/1946/1946429.png" alt="User Icon" width="50" height="50">
							</div>
					...
					<div class="card mb-4">
						...
						<div class="card-body">
							<form>
								...
								<!-- Save changes button-->
								<button class="btn btn-warning" style="display: none;" id="save_edit" onclick="saveEditFields(this)" type="button">Save</button>
								<button class="btn btn-warning" id="edit" onclick="openFields(this)" type="button">Edit</button>
							</form>
						</div>
					</div>
				</div>
